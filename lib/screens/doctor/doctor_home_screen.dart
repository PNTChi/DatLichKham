        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('$name - $info', style: const TextStyle(fontWeight: FontWeight.bold, color: AppColors.navy)),
  ...
  Widget _buildBottomNav() {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.calendar_month_rounded), label: 'Lịch hẹn'),
